...
###### ※ This is the comment at the end of this document.<br/><br/>"This algorithm was not designed for the purposes of ICO.<br/>Coin issuance may be required to raise money needed to implement and validate the algorithm.<br/>Even if a coin is issued, it should be aimed at the proof of concept of the algorithm, not profit.<br/>Compensation schemes are needed and follow the methods of other smart contract algorithms."<br/><br/>This is my personal opinion and not a restriction on the use of this algorithm.<br/><br/>A month and a half ago I first met Satoshi's paper and it was the first time I ever got to know the blockchain.<br/>After I finished reading the paper, I came up with this algorithm and after two weeks I completed the algorithm.<br/>I studied information security at university so it was not that difficult to accept it.<br/><br/>So far, I still do not know deeply nor widely about the blockchain technology and its related industries.<br/>Although I have the ability to invent something new, I am not a superman or a ninja who can do everything.<br/>And there were requests for complete English translation, but I am not accustomed to English and there is no money to ask for translation.<br/><br/>I did not get this algorithm through a lot of effort, so I do not think I own it.<br/>Although it was made for whatever reason, if it is useful for the world, I think it would be better to use it well.<br/><br/>As an opportunity for developers who do not have financially much to realize technology, I think ICO is not a bad way.<br/>I am just sorry that I lack the ability to do it.<br/><br/>Personally, I am looking for a place to work to make money.<br/>It's the best case to do with this algorithm, although I can not, I am trying to find work related to the blockchain.<br/>But as I said earlier, I still do not know much about blockchain.<br/><br/>Although the algorithm was pulled out by me, I hope the value of the algorithm is not underestimated because of my ordinary spec.
<br/>
